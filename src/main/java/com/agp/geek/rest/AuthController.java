...
public class AuthController {
    ...
    @PostMapping("/open/v1/auth/register/first-step")
    ResponseEntity<UUID> registerUser(@RequestBody @Valid InputRegisterUserDTO inputDTO) {
        return ResponseEntity.ok().body(authService.registerUser(inputDTO));
    }

    @PostMapping("/open/v1/auth/valid-code")
    ...
    @GetMapping("/open/v1/auth/valid-token/{token}")
    ...
    @PostMapping("/open/v1/auth/forgot-password")
    ...
    @PostMapping("/open/v1/auth/forgot-password/change-password")
    ...
    @GetMapping("/open/v1/auth/invalidate-user-cache")
